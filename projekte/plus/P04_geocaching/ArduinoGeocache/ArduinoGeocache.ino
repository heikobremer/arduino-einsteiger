// P04: Arduino Geocache - Logbuch mit LCD Keypad Shield
// Original-Version fuer LCD Keypad Shield (parallel LCD + analoge Buttons auf A0)
...
// Button-Lesen ueber Analogwerte (LCD Keypad Shield)
Button readButton() {
  ...
  Button btn = BTN_NONE;
  if (adc < 50)        btn = BTN_RIGHT;
  else if (adc < 195)  btn = BTN_UP;
  else if (adc < 380)  btn = BTN_DOWN;
  else if (adc < 555)  btn = BTN_LEFT;
  else if (adc < 790)  btn = BTN_SELECT;
